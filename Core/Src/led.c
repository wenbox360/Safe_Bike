...
extern TIM_HandleTypeDef htim2;  // TIM4 handle
#define WS2812_DMA_CHANNEL TIM_CHANNEL_1  // Channel 1
...
void WS2812_Send(void)
{
    ...
    HAL_TIM_PWM_Start_DMA(&htim2, TIM_CHANNEL_1, (uint32_t*)ws2812_buffer, LED_COUNT*24);
